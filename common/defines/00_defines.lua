...
NDiplomacy = {
	...
	BASE_PEACE_LIBERATE_FACTOR = 75,				-- Base factor for liberate in %.
	BASE_PEACE_TAKE_UNCONTROLLED_STATE_FACTOR = 1.0, -- Base factor for taking state you do not control
	...
	MIN_WARGOAL_JUSTIFY_COST = 1.0,					-- It always takes at least 5 days to justify a wargoal
	...
	FRONT_IS_DANGEROUS = -25,						-- AI should be unwilling to enter accept a call to war if front is too dangerous.
	NOT_READY_FOR_WAR_VAL_PER_DAY_SINCE_CALL = 1,	-- Value modifying the not ready base over time.
	PEACE_MIN_SCORE = 0.9,							-- Value how much of your score you are always allowed to take
	...
	AUTONOMY_LEVEL_CHANGE_PP_ANNEX = 100,			-- Annexation cost
...
NCountry = {
	...
	POPULATION_YEARLY_GROWTH_BASE = 0.02,			-- basic population growth per year, used for monthly manpower gain
	...
	SUPPLY_CONVOY_FACTOR = 0.01,					-- How many convoys each supply needs
	CONVOY_RANGE_FACTOR = 1,                        -- how much range affects convoy need
	LOCAL_MANPOWER_ACCESSIBLE_NON_CORE_FACTOR = 0.2,  -- accessible recruitable factor base
	...
	MIN_COUP_SUCCESS_STABILITY = 0.9,				-- Max stability when coup will happen
...
NProduction = {
	...
	MAX_CIV_FACTORIES_PER_LINE = 100,	-- Max number of factories that can be assigned a single production line.
...
NBuildings = {
	...
	ROCKETSITE_CAPACITY_MULT = 200,		-- Each level of rocketsite building multiplied by this, gives capacity (max operational value). Value is int. 1 for each rocket.
