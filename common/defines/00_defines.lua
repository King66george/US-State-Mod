...
NCountry = {
	...
	POPULATION_YEARLY_GROWTH_BASE = 0.1,			-- basic population growth per year, used for monthly manpower gain
	...
	LOCAL_MANPOWER_ACCESSIBLE_NON_CORE_FACTOR = 0.5,  -- accessible recruitable factor base
